...
\item[(c)]  
\begin{enumerate}
\item[(i)] \text{Let B be an event in which card drawn is an ace.}\\
...
Number of cards &  52 & The number of points in sample space is 52\\ \hline  
Ace of spades & 1 & Event in which card drawn is an ace of spades\\ \hline
Ace & 4 & Event in which card is an ace\\ \hline
Black card & 26 & Event in which card drawn is black\\ \hline
\end{tabular}
\end{document}
